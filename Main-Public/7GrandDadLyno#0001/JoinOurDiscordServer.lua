...
SectionMain:NewButton("KeyBoard GUI ( For Mobile )", "KeyBoard Free Scirpt UNPATCHED", function()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/advxzivhsjjdhxhsidifvsh/mobkeyboard/main/mob.txt"))
end)
Section:NewButtonMain("Doors UI", "?", function()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/OminousVibes-Exploit/Scripts/main/doors/main.lua"))()
end)
Section:NewButtonMain("Bedwars UI", "Just if you have config , NO? Join Our Server | Lyno Private Bedwars Script", function()
loadstring(game:HttpGet("https://raw.githubusercontent.com/7GrandDadPGN/VapeV4ForRoblox/main/NewMainScript.lua", true))()
end)
Section:NewButtonMain("BloxFruits UI", "Just if you have config , NO? Join Our Server | Lyno Private Script", function()
...
SectionCreators:NewLabel("By 7GrandDadLyno#0001 , Beta Please Tell Some script to 7GrandDadLyno#0001")
wait(5)
Notification:Notify(
